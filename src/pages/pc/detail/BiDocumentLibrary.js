...
const DocumentLibrary = () => {
  ...
  const columns = [
    ...
    },
    {
      ...
      render: (text) => {
     return   <a onClick={()=>{
        navigate(`/AI/BiDocumentManagement/Files?path=${text}`, { replace: true });
     }}>查看文件</a>;
      },
    },
  ];
  ...
  useEffect(() => {
    ...
    getDocumentLibraryList({ page: page, size: pageSize, document_type: "bi" }).then(
      (res) => {
